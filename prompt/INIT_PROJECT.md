...
7. Redesign ใน folder /Users/marosdeeuma/care-team-nextjs/app/manage-register

ให้ใช้ layout ใหม่ สำหรับหน้า admin ด้วยคับ

โดยให้มี left side bar   เปิดปิดได้ และรองรับ responsive

css design mood ให้ consistency กับ ui เดิม
